...
description: Generate or refresh the Architecture/Code Catalog and architecture documentation from the repo, including C4 Mermaid docs, sequence diagrams, ADR baseline, and system-map.yaml.
---

# PP Arch Catalog

Generate a structured Architecture/Code Catalog and architecture docs from the
current repository.
